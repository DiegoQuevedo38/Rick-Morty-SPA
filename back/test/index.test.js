const server = require("../src/app"); // importo el servidor
const session = require("supertest"); // importo a supertest
const agent = session(server); // configuro el entorno de supertest
